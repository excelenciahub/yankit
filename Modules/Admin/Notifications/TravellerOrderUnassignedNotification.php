...
class TravellerOrderUnassignedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line(new HtmlString('This email is to inform you that order(<b>'.$this->order->order_no.'</b>) has been unassigned from you. Sender detail is as below.'))
                    ->line(
                        new HtmlString(
