...
<main style="margin-top: 135px;">
    ...
    <div class="container">
        <div class="row gs-bg-style pt-5" style="padding: 15px;">
            <div class="col-lg-5">
                ...
                <div class="card">
                    ...
                    <div class="card-body nopadding">
                        <ul class="list-group shadow-none pb-4">
                            ...
                            <div class="list-details">
                                <small>Address</small>
                                <div class="mt-2">{{ auth()->user()->address }}</div>
            ...
            <div class="col-lg-7">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-pane" id="edit">
                        {{ Form::model($user, ['route'=>['sender.profile.update', $user->id], 'method'=>'PATCH', 'class'=>'form ajaxform', 'id'=>'profile_form', 'files'=>true]) }}
                            ...
                            <div class="form-group row save_profile hide">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="submit" class="btn_login-gs float-right" value="Save Changes">
                                </div>
                            </div>
                            {{ Form::close() }}
                        </div>
